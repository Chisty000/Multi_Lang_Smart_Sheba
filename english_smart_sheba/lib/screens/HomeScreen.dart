...
class _ChatPageState extends State<ChatPage> {
  final _openAI = OpenAI.instance.build(
    token: "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",
